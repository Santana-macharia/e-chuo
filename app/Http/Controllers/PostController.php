...
class PostController extends Controller
{
    ...
    public function index(){
        ...
        $pages = Post::select('id', 'title', 'slug', 'created_at')->whereType('page')->orderBy('id', 'desc')->paginate(20);
    ...
    public function posts(){
        ...
        $posts = Post::select('id', 'title', 'slug', 'created_at')->whereType('post')->orderBy('id', 'desc')->paginate(20);
    ...
    public function showPage($slug){
        ...
        $title = $page->title;
        return view('theme.echuo.single_page', compact('title', 'page'));
    }

    public function blogIndex(){
        $posts = Post::whereType('post')->whereStatus('1')->with('author', 'feature_img')->paginate(20);
        $title = trans('app.blog');
        return view('theme.echuo.blog', compact('title', 'posts'));
    }
