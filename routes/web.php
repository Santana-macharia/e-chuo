...
Route::get('/', ['as' => 'home', 'uses'=>'AdsController@search']);
...
//echuo
Route::get('search', ['as' => 'search', 'uses'=>'AdsController@search']);
Route::get('school/{slug}', ['as' => 'single_school', 'uses'=>'AdsController@singleSchool']);
